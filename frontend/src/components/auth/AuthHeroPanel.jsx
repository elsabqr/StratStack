...
// Completely locked down to match your exact original panel dimensions
...
// Original image limits restored, using hard scale & rotation transforms instead
const heroImageClassName = [
  "h-auto max-h-[min(44vh,380px)] w-[min(92%,19rem)]", // Restored your original crisp boundaries
  "animate-[auth-float-y_4.5s_ease-in-out_infinite]",
  "scale-180 rotate-25", // Hard forces the asset 25% bigger and tilts it clockwise without bloating the panel
...
export function AuthHeroPanel() {
  return (
    <section className={heroPanelClassName}>
      ...
      {/* Restored exact original layout padding */}
